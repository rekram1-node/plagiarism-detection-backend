module github.com/rekram1-node/plagiarism-detection-backend
...
require (
	...
	github.com/rekram1-node/text-processor v0.4.0
)
...
require (
	...
	github.com/neurosnap/sentences v1.1.1 // indirect
